...
| BETA-MOD-STAFF-009 | P0        | В работе      | Защитить attachments и evidence                     | Reader всех семи parent kinds, native atomic binding/unbind/quarantine, bind/unbind/replacement races и persisted-user/custom-role/system-role revoke приняты. Knowledge/regulation/training/onboarding/checklist parents используют совпадающую fresh `NETWORK \| STORES` authority. Production read-only trigger inventory `7/7` принят на admitted SHA, но aggregate scan выявил `5 446 UNRESOLVED`, `309` multiple-parent, `741` unreferenced и `243` URL-review cases. До завершения нужны audited reconciliation/backfill + zero-diff, затем archive/delete/orphan/retention production-build browser matrix и общий file journey                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | BETA-MOD-STAFF-001, BETA-SEC-006 |
