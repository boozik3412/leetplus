-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('OWNER', 'MANAGER', 'BUYER', 'ADMIN');
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_tenantId_article_key" ON "Product"("tenantId", "article");
