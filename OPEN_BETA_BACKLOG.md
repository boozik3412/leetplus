...
отклоняются до network I/O, counters остаются zero. Actual co-located topology
ещё обязательна; внешний доступ — `NO-GO`.
...
| `CURRENT187-J5-R6`                   |        P0 | `ENGINEERING ACCEPTED LOCALLY / PRODUCTION-ORIGIN FENCE / NO PROD EFFECT`         | Separate strict WeakSet brands distinguish actual public J1/J2/J3/J4 collectors from production-mode `WithDependenciesForTestOnly` receipts; production runner consumes only strict actual-origin brands. Four dependency-backed J1/J2 receipts plus J3/J4 chain are proven non-admissible before network I/O with zero harness counters; integration `2/2`; generic test verifiers remain available without conferring runner authority                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Exact-SHA CI; actual co-located J1–J4 topology acquisition through public collectors; protected production signer/key/root; canonical ledger/runtime roles; restored-copy rehearsal and independent review                                                 |
