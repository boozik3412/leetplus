...
8. Production-like stop-v1/apply/grant/start-v2/rollback rehearsal, exact-SHA
   CI, independent final review и отдельный `PRODUCTION DEPLOY GO`.
