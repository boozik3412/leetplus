...
function readinessInput() {
  return {
    ...
    expectedMigration: '20260908180000_external_langame_simple_onboarding',
    expectedMigrationCount: 191,
...
function readinessReceipt(
  ...
  return {
    ...
    decision: 'READY',
    tenantId: TENANT_ID,
    migrationHead: '20260908180000_external_langame_simple_onboarding',
    migrationCount: 191,
