...
const quickSyncTitle =
  'Быстрая синхронизация ассортимента и продаж с даты последней синхронизации. Для ручного периода перейдите в "Настройки"';
...
export function DashboardQuickSyncButton() {
  ...
  return (
    <span className="relative inline-flex items-center gap-2">
      ...
      >
        {isSyncing ? "Обновление..." : "Обновить товары"}
      </button>
    </span>
  );
}
