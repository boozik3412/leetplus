...
- Готово: компактный sidebar разделяет активную страницу и раскрытие раздела по наведению: на `/dashboard` зеленой остается только иконка `Главная`, а `Ассортимент` не выглядит выбранным при простом hover.
