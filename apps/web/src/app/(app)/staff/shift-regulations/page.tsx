        ...
        <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              Соберите стандарт открытия, закрытия, кассы, бара или PC-зоны:
              разделы, пункты, обязательность, тип контроля, доказательства и
              баллы качества. Опубликованный регламент станет основой для
              будущих сменных чеклистов.
            </p>
          </div>
          <Link
            href="/staff/tasks"
