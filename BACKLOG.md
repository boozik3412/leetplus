...
- Запланированная аналитика: retention, heatmaps, LTV, bonus load, расширенный campaign effect и guest-flow forecasts. RFM v1 и churn risk v1 уже добавлены в полный отчет гостей и export.
