...
import { inspectNative, observe } from './release-observer.mjs';
...
function fixture() {
  ...
  return { plan, records: {}, packet: { decision: 'PREPARED_NOT_AUTHORIZATION', nativePlanSha256: digest(plan), nativeOperationId: plan.operationId, workerContinuation: plan.workerContinuation }, publicKey: key.publicKey.export({ type: 'spki', format: 'pem' }) };
}
