...
- Planned: add preview/test mode for employee-facing templates and materials: shift regulations, checklist templates, task templates, training/onboarding steps, and knowledge-base articles should have a "view as administrator/employee" preview so managers can test the flow without logging in under an administrator account.
