...
- Hardened the standalone main dashboard navigation: `/dashboard`, root, query-string and trailing-slash variants resolve to `Главная`, while `Ассортимент` remains active only for explicit assortment routes.
