...
- Готово: главный `/dashboard` очищен от ассортиментного URL-параметра `skuGrouping`; старые ссылки с ним канонически переадресуются на чистую главную страницу, а фильтры главной больше не добавляют этот параметр обратно.
