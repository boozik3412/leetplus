...
1. Принять CURRENT187-I candidate независимой latest-byte проверкой; exact-head
   ...
   J5 `26/26`, aggregate CURRENT187 `105/105`. Следующим шагом выполнить branded
   J1–J4 production-like 36-outcome run, затем external key ceremony/ACL-HSM и
   reviewed root enrollment, после чего закрыть CURRENT187
