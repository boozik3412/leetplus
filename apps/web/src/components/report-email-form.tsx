...
const REPORT_EXPORT_DESCRIPTION =
  "Будет отправлен сводный файл за выбранный период: общий отчет по продажам, операционная сводка, рекомендации, OOS, товары без продаж, остатки, ABC, ТОП SKU/поставщиков и ассортимент.";
    ...
    <section className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm">
      <div className="mb-4">
        ...
        <p className="mt-1 max-w-4xl text-sm text-zinc-500">
          ...
          общий отчет по продажам, рекомендации, OOS, товары без продаж,
          остатки и потребность, ABC, ТОП SKU/поставщиков и ассортимент.
        </p>
      </div>
