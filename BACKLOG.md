...
- Done: `/reports` has a compact fallback state: if one of the report data requests fails, users still see regular digest sending and direct links to full report pages instead of a broken page.
