...
for (const name of ['images.tar.gz', 'release.json', 'control.tar.gz', 'compose.rehearsal.json', 'transport-validation.json']) {
...
const admission = { contract: `${CONTRACT}_ADMISSION`, decision: 'PASS', releaseSha: sha,
  ...
  transportValidationSha256: sums.get('transport-validation.json'), images: r.images };
