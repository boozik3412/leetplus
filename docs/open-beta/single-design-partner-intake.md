# Intake optional isolated design partner
...
основным intake первого shared клуба, не разрешает выдачу доступа и не
содержит инфраструктурных секретов. Использовать его можно только после
отдельного решения о contingency/enterprise isolation.
