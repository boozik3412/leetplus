...
- Gate 1MT staff STORES successor: knowledge (`085f8bbd…`), shift regulations
  (`6ce36a41…`), training (`40a8e828…`) и onboarding (`26b9f442…`) приняты на
  disposable PostgreSQL и production-build B1↔B2 browser. Onboarding включает
  unit `55/55`, Web BFF `15/15`, pilot HTTP `160/160`, PostgreSQL `12/12`,
  hidden foreign mutation `404` и forbidden foreign Store filter `403`.
  Exact SHA принят push CI `32220369599` как `4/4 SUCCESS`.
  Осталась одна ранее network-only parent family: checklists/templates; общий
  release decision остаётся `NO-GO`.
...
| BETA-MOD-STAFF-005 | P0        | В работе      | Закрыть регламенты и чек-листы                      | Shift regulations приняты на exact `6ce36a41…`: fresh `NETWORK                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | STORES`, assessment/acknowledgement/files, unit `53/53`, Web BFF `13/13`, restored-copy PG `10/10`, B1↔B2 browser; remote successor `542c8126…`CI`32187880656` green. До готовности остаются checklists/templates и archive/orphan матрица                         | BETA-MOD-STAFF-001               |
| BETA-MOD-STAFF-006 | P0        | В работе      | Закрыть знания, обучение и аттестации               | Knowledge exact `085f8bbd…` и training exact `40a8e828…` приняты с fresh `NETWORK                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | STORES`parent/file policy. Training: unit`54/54`, Web BFF `14/14`, pilot HTTP `160/160`, restored-copy PG `11/11`, production-build B1↔B2 browser; foreign mutation/filter `404/403`. До готовности остаются onboarding и полный tests/assessments/readiness slice | BETA-MOD-STAFF-001, BETA-IAM-002 |
...
| BETA-MOD-STAFF-009 | P0        | В работе      | Защитить attachments и evidence                     | Upload/download проверяют parent resource, capability и fresh tenant/store authority; PENDING/BOUND/UNRESOLVED/QUARANTINED lifecycle, тип/размер и private/no-store transport определены в `docs/security/access-scope/v1/attachment-acl-rollout.md`. Exact `abb8a667…` принимает reader всех семи parent kinds: пять tenant-wide staff parents требуют fresh NETWORK и exact same-tenant parent; unit `26/26`, restored-copy `4/4 + 4/4`, zero table diff/residue. До готовности остаются native atomic binding writers пяти parent kinds, STORES policies, browser/race и retention/delete workflow                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | BETA-MOD-STAFF-001, BETA-SEC-006                                                                                                                                                                                                                                   |
...
После этого slice в прежней network-only parent последовательности остаются
только checklists/checklist templates. Tests/assessments/readiness и общий
Gate 1MT всё ещё не закрыты.
