...
CURRENT187-J5-R7 локально закрывает входной mTLS-разрыв J4. Production collector
...
typecheck green. Exact-SHA CI и actual co-located public-collector topology ещё
обязательны; production и внешний доступ остаются `NO-GO`.
