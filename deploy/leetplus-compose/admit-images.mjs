...
const admission = { contract: `${CONTRACT}_ADMISSION`, decision: 'PASS', releaseSha: sha,
  ...
  transportValidationSha256: sums.get('transport-validation.json'), archiveRoundtripSha256: sums.get('archive-roundtrip.json'), networkValidationSha256: sums.get('network-validation.json'), images: r.images };
