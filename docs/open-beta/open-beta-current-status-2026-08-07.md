...
| CURRENT187-J5-R8 actual J4 mTLS   | `IMPLEMENTED LOCALLY / EXACT-SHA CI PENDING`             | disposable CA signs separate server/client certificates; PostgreSQL TLS and PgBouncer client/server verify-full are configured before public actual J4 collection. Integration requires strict production-origin brand and zero PEM/raw hashes/passwords in receipt. Shell/Node syntax, formatting and diff checks pass; actual Ubuntu/PostgreSQL execution and co-located J1–J4 topology pending                                                                      |
