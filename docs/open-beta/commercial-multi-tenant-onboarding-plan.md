...
| Gate 1MT tenant/store isolation              | PostgreSQL A/B `35/35 PASS`; report/SSE/OWNER attachment, knowledge, shift, training и onboarding STORES browser приняты; один staff parent и background остаток открыты |
