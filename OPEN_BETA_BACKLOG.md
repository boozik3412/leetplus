...
CURRENT187-J5-R5 локально добавляет отдельный pure successor policy: он требует
...
refreeze `17/17` и assembler `21/21`
green. Результат остаётся synthetic/non-consumable без production/access/effect
authority; внешний доступ — `NO-GO`.
