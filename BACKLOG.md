...
- Готово: при переходе на `/dashboard` раскрытые по hover продуктовые группы сбрасываются, поэтому сводный дашборд не сохраняет визуальную подсветку `Ассортимент` после старых ссылок, фильтров или навигации из разделов.
