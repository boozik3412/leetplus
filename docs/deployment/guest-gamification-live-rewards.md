...
- Расширенный редактор на `/guests/gamification` является источником правил, условий, статуса и клубной области. Активация элемента после подтверждения сразу делает его доступным в игровом контуре выбранных клубов.
...
- `/guests/gamification` показывает диагностические решения правила, факты игрового журнала, freshness источника и историю наград. Для тестов используйте эти данные вместе с summary гостя.
