    ...
    <section className="rounded-lg border border-white/10 bg-[#0b111c] p-5">
      ...
      <div className="mt-4 rounded-lg border border-white/10 bg-white/[0.035] p-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <p className="text-sm font-black text-white">История решений</p>
          <span className="rounded-full border border-white/10 bg-black/20 px-2 py-1 text-xs font-bold text-slate-300">
            {communicationHistory.length} записей
          </span>
        </div>
        {communicationHistory.length > 0 ? (
          ...
          <p className="mt-3 rounded-lg border border-dashed border-white/10 bg-black/20 px-3 py-2 text-sm leading-6 text-slate-400">
            История появится после первого решения по игровым коммуникациям.
          </p>
        )}
      </div>
    </section>
