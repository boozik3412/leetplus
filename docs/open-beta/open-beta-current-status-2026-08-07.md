...
> `10/10`, aggregate CURRENT187 `89/89`, typecheck green. Capability-bearing 36-probe
> runner, production signer/root и persisted consumption ещё отсутствуют;
...
| CURRENT187-J5 signed probes      | `ENGINEERING ACCEPTED LOCALLY / SYNTHETIC CONTRACT / DENY-ONLY` | independent Ed25519 verifier; 4 service purposes × (positive + 8 negative scenarios), 5-minute freshness, identity/evidence separation, frozen-empty production root; `10/10`, aggregate `89/89`, typecheck green; actual runner/signer/persistence/F binding pending                                                                                       |
...
J5 independently signed connection-probe contract принят локально: `10/10`,
aggregate CURRENT187 `89/89`. Ближайший этап — реализовать capability-bearing
36-probe runner и protected production signer/root, затем завершить independent
