...
install -d -o root -g leetplus-runtime -m 0550 "$NESTED_MOUNT_SOURCE"
printf 'fixture\n' > "${NESTED_MOUNT_SOURCE}/.ci-legacy-rollback-fixture"
chown root:leetplus-runtime "${NESTED_MOUNT_SOURCE}/.ci-legacy-rollback-fixture"
chmod 0440 "${NESTED_MOUNT_SOURCE}/.ci-legacy-rollback-fixture"
