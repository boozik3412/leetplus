...
| `CURRENT187-J`                       |        P0 | `EXACT-HEAD CI ACCEPTED / SYNTHETIC-CI-ONLY / DENY-ONLY`                         | exact `APPLICATION/COORDINATOR/MIGRATION/WORKER` probe matrix; separate branded network and host-control receipts; deterministic endpoint/TLS/HBA/pooler/service-account digests; `VERIFY_FULL`, safe HBA auth, SESSION lock/migration paths, positive+negative probes and pairwise distinct service mappings enforced; clone/proxy/accessor/sparse/cross-release/trust/wildcard/user-collapse hostile matrix `10/10`, aggregate CURRENT187 `42/42`; SHA `04ffff27…`, CI `31420665364` — `3/3 SUCCESS`, artifact `sha256:0cb6ac6e…bd337`; all access/effect flags false                                                                                                                                                                                                                                                                                                                                 | Actual capability-bearing TCP/TLS/HBA/PgBouncer collectors; independent host signer/root; freshness/reload epoch and persisted consumption/revocation; hostile real topology matrix; exact binding into F/deploy authority; independent review |
