...
CURRENT187-J3/J4 добавляют local candidate actual read-only control-plane
...
typecheck green. Exact-SHA CI и actual PgBouncer fixture pending; production
...
| `CURRENT187-J`                       |        P0 | `FOUNDATION + J1/J2 EXACT-HEAD / J3/J4 LOCAL CANDIDATE / DENY-ONLY`               | Foundation/J1/J2 приняты exact-SHA CI; J2 SHA `d386dfa2…`, CI `31584476362` `3/3 SUCCESS`, artifact `sha256:722f77c2…f495`. J3 actual read-only `pg_hba_file_rules` + reload-clock collector: trust/plaintext/wildcard/regex/group/map deny, `8/8`; current file observed, effective loaded HBA/rule not attested. J4 PgBouncer simple-query SHOW collector: global/database/user/runtime transaction mode, backend/TLS mapping, `force_user`/stale mapping deny, `7/7`. Aggregate CURRENT187 `78/78`, typecheck green. J3/J4 CI pending; production root/runtime, negative probes и все access/effect flags false                                                                                                                                                                                                                                                                       | Exact-SHA CI J3/J4; actual PgBouncer fixture; four production J1/J2 service runs + J3/J4 control runs; positive/negative connection probes; signer/root, freshness and persisted consumption/revocation; hostile topology; binding into F/deploy authority; independent review |
...
1. Принять CURRENT187-I candidate независимой latest-byte проверкой; exact-head
   ...
   exact-SHA CI. CURRENT187-J3 HBA/reload и J4 PgBouncer collectors реализованы
   локально и требуют exact-SHA CI + actual PgBouncer fixture. Следом добавить
